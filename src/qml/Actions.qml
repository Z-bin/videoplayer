...
Item {
    ...
    property alias contrastUpAction: contrastUpAction                       // 增加对比度
    property alias contrastDownAction: contrastDownAction                   // 减少对比度
    property alias brightnessUpAction: brightnessUpAction                   // 增加亮度
    property alias brightnessDownAction: brightnessDownAction               // 减少亮度
    property alias gammaUpAction: gammaUpAction                             // gama数值增加
    property alias gammaDownAction: gammaDownAction                         // gama数值减少
    property alias saturationUpAction: saturationUpAction                   // 增加饱和度
